...
\vspace{3cm}
\title{Audio Filter}
\author{EE23BTECH11202 - Abhey garg$^{*}$% <-this % stops a space
}
\maketitle
\newpage
\bigskip
...
\begin{lstlisting}
$https://github.com/Abhey-05/Abhey/blob/main/Audio_Filter/codes/abhey_singing.wav
\end{lstlisting}
\item 
\label{Python code}
...
\begin{figure}[H]
    \includegraphics[width=0.8\columnwidth]{figs/before.jpg}
    \caption{Spectrogram of the audio file before Filtering}
    \label{fig:before_filter_plot}
\end{figure}
\begin{figure}[H]
\includegraphics[width=0.8\columnwidth]{figs/after.jpg}
...
\begin{lstlisting}
https://github.com/Abhey-05/Abhey/blob/main/Audio_Filter/codes/2_2.c
\end{lstlisting} 
The following code plots \eqref{prob:2.1} and \eqref{prob:2.2}
\begin{lstlisting}
https://github.com/Abhey-05/Abhey/blob/main/Audio_Filter/codes/2.2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Abhey-05/Abhey/blob/main/Audio_Filter/codes/3.5.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Abhey-05/Abhey/blob/main/Audio_Filter/codes/4.2.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Abhey-05/Abhey/blob/main/Audio_Filter/codes/4.4.py
\end{lstlisting}
\begin{figure}[!ht]
\centering
...
%
\begin{lstlisting}
https://github.com/Abhey-05/Abhey/blob/main/Audio_Filter/codes/4.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Abhey-05/Abhey/blob/main/Audio_Filter/codes/5_sol.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Abhey-05/Abhey/blob/main/Audio_Filter/codes/5.4.py   
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Abhey-05/Abhey/blob/main/Audio_Filter/codes/5.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Abhey-05/Abhey/blob/main/Audio_Filter/codes/6.1.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Abhey-05/Abhey/blob/main/Audio_Filter/codes/6.2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Abhey-05/Abhey/blob/main/Audio_Filter/codes/6_filter_response.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\end{align}
\begin{lstlisting}
https://github.com/Abhey-05/Abhey/blob/main/Audio_Filter/codes/analog_filt.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Abhey-05/Abhey/blob/main/Audio_Filter/codes/6.2_pole-zero.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Abhey-05/Abhey/blob/main/Audio_Filter/codes/fft.c
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Abhey-05/Abhey/blob/main/Audio_Filter/codes/fft_python.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Abhey-05/Abhey/blob/main/Audio_Filter/codes/6.4_time.c
\end{lstlisting}
The below python code extracts the data from these text files and plots Time vs $n$ for comparison.
\begin{lstlisting}
https://github.com/Abhey-05/Abhey/blob/main/Audio_Filter/codes/6.4_plot.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\solution The Sampling Frequency is 44.8KHz
\item
What is type, order and  cutoff-frequency of the above butterworth filter
\\
\solution The given butterworth filter is lowpass with order=4 and cutoff-frequency=9kHz.
